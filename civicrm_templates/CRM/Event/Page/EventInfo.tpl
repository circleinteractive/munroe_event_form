...
<div class="vevent crm-event-id-{$event.id} crm-block crm-event-info-form-block">
    ...
    <div class="crm-actionlinks-top">
      {crmRegion name="event-page-eventinfo-actionlinks-top"}
        {if $allowRegistration}
          ...
          {* customization - change button href, styling + add back button *}
          <div class="action-link section register_link-section register_link-top" style="float:none;">
            <a style="float:left; color:#444" class="btn btn-default" href="/" title="{ts}Back to event listing{/ts}">« {ts}Back to event listing{/ts}</a>
            <a style="float:right; color:white" class="btn btn-primary" href="/event-registration?id={$event.id}" title="{$registerText}">{$registerText} »</a>
          </div>
  ...
  {if $event.summary}
      <div class="crm-section event_summary-section" style="clear:both; padding-top:10px">
        {$event.summary}
      </div>
  {/if}
    ...
    <div class="crm-actionlinks-bottom">
      {crmRegion name="event-page-eventinfo-actionlinks-bottom"}
        {if $allowRegistration}
          ...
          {* customization - change button href, styling + add back button *}
          <div class="action-link section register_link-section register_link-bottom" style="float:none;">
            <a style="float:left; color:#444" class="btn btn-default" href="/" title="{ts}Back to event listing{/ts}">« {ts}Back to event listing{/ts}</a>
            <a style="float:right; color:white" class="btn btn-primary" href="/event-registration?id={$event.id}" title="{$registerText}">{$registerText} »</a>
          </div>
          {* end of customization *}
